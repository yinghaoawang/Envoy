...
const MessageInput = (props) => {
  ...
  return (
    <div className='text-muted d-flex justify-content-start align-items-center pt-3 mt-2 pe-3 w-100'>
      <img
  ...
  return (
    <div className='h-100'>
      <div className='col-md-12 h-100'>
        <div className='card bg-transparent p-3 h-100' id='chat3'>
          <div className='card-body'>
            <div
              className='mt-auto pt-3 pe-3 '
